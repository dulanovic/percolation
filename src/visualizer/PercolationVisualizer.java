package visualizer;
/** ****************************************************************************
 *  Compilation:  javac visualizer.PercolationVisualizer.java
 *  Execution:    java visualizer.PercolationVisualizer input.txt
 *  Dependencies: model.Percolation.java
 *
...
public class PercolationVisualizer {
    ...
    public static void main(String[] args) {
        In in = new In("_data/input7.txt");       // input file
